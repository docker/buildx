...
| [`rfc3339parse`](#rfc3339parse)             | Given an RFC3339 timestamp string, will parse and return an object representation of that date and time.                                                                                                     |
...
### <a name="rfc3339parse"></a> `rfc3339parse`
...
target "default" {
  args = {
    ...
    BUILD_TIMESTAMP = rfc3339parse(BUILD_TIME).unix
  }
}
```
...
```json
{
  ...
  "target": {
    "default": {
      ...
      "dockerfile": "Dockerfile",
      "args": {
        "BUILD_DATE": "2025-07-13T10:09:32Z",
        "BUILD_TIMESTAMP": "1752401372"
      }
    }
  }
}
...
target "default" {
  args = {
    BUILD_DATE = unixtimestampparse(BUILD_TIMESTAMP).rfc3339
...
```json
{
  ...
  "target": {
    "default": {
      ...
      "dockerfile": "Dockerfile",
      "args": {
        "BUILD_DATE": "2023-07-25T23:43:16Z",
        "BUILD_TIMESTAMP": "1690328596"
      }
    }
  }
}

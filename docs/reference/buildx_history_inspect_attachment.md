...
```console
$ docker buildx history inspect attachment ^0 --type manifest
{
  "schemaVersion": 2,
  "mediaType": "application/vnd.oci.image.manifest.v1+json",
  "config": {
...
```console
$ docker buildx history inspect attachment ^0 --type provenance
{
  "builder": {
    "id": ""
  },
...
```console
$ docker buildx history inspect attachment ^0 --platform linux/amd64
{
  "schemaVersion": 2,
  "mediaType": "application/vnd.oci.image.manifest.v1+json",
  "config": {

...
func (o *CacheOptions) FromNativeValue(in cty.Value, p cty.Path) error {
	got := in.Type()
	if got.IsTupleType() || got.IsListType() {
		return o.fromNativeValue(in, p)
	}
...
func (o CacheOptions) ToNativeValue() cty.Value {
	if len(o) == 0 {
...
func (o *CacheOptionsEntry) FromNativeValue(in cty.Value, p cty.Path) error {
...
func (o *CacheOptionsEntry) ToNativeValue() cty.Value {
	if o == nil {
